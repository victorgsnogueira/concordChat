...
function Sidebar({ currentUserId }) {
  ...
  return (
      ...
      <div
        ref={sidebarRef}
        className={`h-[calc(100vh-2rem)] min-w-[80px] bg-[#101010] text-white m-[16px] rounded-lg  flex flex-col justify-between transition-all duration-300 ${isSidebarExpanded ? 'w-[230px]' : 'w-[80px]'
          } overflow-hidden`}
      >
